...
## Architectural Structure
 ...
 An *Autonomous System* is composed of one or more *Autonomous Subsystems*, an each Autonomous Subsystem is in turn composed of one or more *Autonomous Services*.
